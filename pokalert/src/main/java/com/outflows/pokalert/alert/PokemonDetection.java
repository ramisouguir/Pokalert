...
public class PokemonDetection implements Runnable
{
	...
	private static boolean swoInProgress = false; //show pokemon with owners
	private static boolean showDialogBox = true;
	private static KeyBinding box = pokalert.box;
	public static ArrayList<String> badforms = new ArrayList<>(Arrays.asList("Hyppopotas", "Hippowdon", "Frillish", "Jellicent", "Pyroar", "Lycanroc", "Basculin", "Unfezant", "Cherrim", "Oricorio", "Unown", "Deerling", "Castform", "Burmy", "Shellos", "Wormadam", "Gatrodon", "Sawsbuck", "Flabebe", "Floette", "Florges"));
